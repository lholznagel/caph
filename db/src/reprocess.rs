...
impl Into<Arc<dyn Cache>> for ReprocessCache {
...
#[async_trait]
impl Save for ReprocessCache {
    type Typ = Typ;

    fn file(&self) -> &str {
        "./db/reprocessing.cachem"
    }
