...
eve_id!(ActivityId, u32, i32);
eve_id!(AgentId, u32, i32);
eve_id!(AllianceId, u32, i32);
eve_id!(AttributeId, u32, i32);
eve_id!(CategoryId, u32, i32);
eve_id!(CharacterId, u32, i32);
eve_id!(ConstellationId, u32, i32);
eve_id!(CorporationId, u32, i32);
eve_id!(DisplayNameId, u32, i32);
eve_id!(DivisionId, u32, i32);
eve_id!(DogmaCategoryId, u32, i32);
eve_id!(EffectId, u32, i32);
eve_id!(FactionId, u32, i32);
eve_id!(FittingId, u32, i32);
eve_id!(GraphicId, u32, i32);
eve_id!(GroupId, u32, i32);
eve_id!(IconId, u32, i32);
eve_id!(ItemId, u64, i64);
eve_id!(LocationId, u64, i64);
eve_id!(MarketGroupId, u32, i32);
eve_id!(MaterialSetId, u32, i32);
eve_id!(MetaGroupId, u32, i32);
eve_id!(OperationId, u32, i32);
eve_id!(OrderId, u64, i64);
eve_id!(PlanetId, u32, i32);
eve_id!(PlayerId, u32, i32);
eve_id!(RaceId, u32, i32);
eve_id!(RegionId, u32, i32);
eve_id!(SchematicId, u32, i32);
eve_id!(ServiceId, u32, i32);
eve_id!(SkinId, u32, i32);
eve_id!(SkinLicenseId, u32, i32);
eve_id!(SkinMaterialId, u32, i32);
eve_id!(SolarSystemId, u32, i32);
eve_id!(SoundId, u32, i32);
eve_id!(StarId, u32, i32);
eve_id!(StargateId, u32, i32);
eve_id!(StationId, u32, i32);
eve_id!(TypeId, u32, i32);
eve_id!(UnitId, u32, i32);
